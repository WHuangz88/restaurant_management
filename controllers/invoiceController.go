...
func GetInvoices() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "failed listing invoices"})
			return
		}
...
func GetInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if err != nil {
			c.JSON(http.StatusInternalServerError, gin.H{"error": "failed while getting invoice"})
			return
		}
...
func CreateInvoice() gin.HandlerFunc {
	return func(c *gin.Context) {
		...
		if insertErr != nil {
			msg := fmt.Sprintf("Invoice item was not found")
			c.JSON(http.StatusInternalServerError, gin.H{"error": msg})
			return
		}
